...
*/
	...
	private static final InstructionDecoder oneByteTable[] = {
		...
		new InstructionDecoder("pushl", ADDR_I, b_mode), /* push of byte really pushes 4 bytes (or 2 with data prefix) */
		...
		new InstructionDecoder("leaS", ADDR_G, v_mode, ADDR_E, v_mode),  // JK: was ("leaS", ADDR_G, v_mode, ADDR_E, 0); but mode 0 introduced errors!  
		...
		// Made fwait an instruction, too, to handle multiple fwait prefixes!
		...
		new RetDecoder("ret"),
		new InstructionDecoder("lesS", ADDR_G, v_mode, ADDR_E, p_mode),    // JK: changed 0 to p_mode according to lgs, lfs
		...
		new RetDecoder("lret", ADDR_I, w_mode),
		new RetDecoder("lret"),
		...
		new FloatDecoder(),
		/* e0 */
		new ConditionalJmpDecoder("loopne", ADDR_J, b_mode),
		new ConditionalJmpDecoder("loope", ADDR_J, b_mode),
		new ConditionalJmpDecoder("loop", ADDR_J, b_mode),
	...
	private static final InstructionDecoder twoByteTable[] = {
		...
		new SSEInstructionDecoder("rdtsc"),
		...
		/* d0 */
		null,
		new SSEArithmeticDecoder("psrlw", ADDR_P, q_mode, ADDR_Q, q_mode, Operation.SRL),
		...
		new SSEArithmeticDecoder("pmullw", ADDR_P, q_mode, ADDR_Q, q_mode, Operation.SMUL),
		null,
		...
		new SSEArithmeticDecoder("pmulhw", ADDR_P, q_mode, ADDR_Q, q_mode, Operation.SMUL),
		null,
		...
		/* f0 */
		null,
		new SSEArithmeticDecoder("psllw", ADDR_P, q_mode, ADDR_Q, q_mode, Operation.SLL),
		...
		new SSEArithmeticDecoder("paddd", ADDR_P, q_mode, ADDR_Q, q_mode, Operation.ADD),
		null
	};
	...
	private static final InstructionDecoder twoBytePrefix66Table[] = {
		...
		/* d0 */
		null,
		new SSEArithmeticDecoder("psrlw", ADDR_V, dq_mode, ADDR_W, dq_mode, Operation.SRL),
		...
		/* f0 */
		null,
		new SSEArithmeticDecoder("psllw", ADDR_V, dq_mode, ADDR_W, dq_mode, Operation.SLL),
		...
		new SSEArithmeticDecoder("paddd", ADDR_V, dq_mode, ADDR_W, dq_mode, Operation.ADD),
		null
	};
}
