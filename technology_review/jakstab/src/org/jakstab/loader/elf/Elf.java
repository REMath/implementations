...
public class Elf {
	...
	public Elf(String file, long offset) throws BinaryParseException {
		commonSetup(file, offset);
	}

	public Elf(String file) throws BinaryParseException {
		commonSetup(file, 0);
	}
	...
	public Attribute getAttributes() throws BinaryParseException {
	...
	public Section getSectionByName(String name) throws BinaryParseException {
		if (sections == null)
			getSections();
	...
	public Section[] getSections(int type) throws BinaryParseException {
		if (sections == null)
			getSections();
	...
	public Section[] getSections() throws BinaryParseException {
		if (sections == null) {
			if (ehdr.e_shoff == 0) {
	...
	public void loadSymbols() throws BinaryParseException {
		if (symbols == null) {
