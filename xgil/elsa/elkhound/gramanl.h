...
// ------ representation ------
private:    // data
  Production const *prod;        // (serf) the base production. cannot be error recovery.
...
public:     // funcs
  ...
  // get the list of error recovery productions that can be reduced
  // for this state.
  void getPossibleErrorReductions(ProductionList &reductions,
