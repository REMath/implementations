...
public class FPArithmeticDecoder extends FPInstructionDecoder {
   ...
   public FPArithmeticDecoder(String name, int addrMode1, int operandType1, Operation rtlOperation) {
      super(name, addrMode1, operandType1);
      this.rtlOperation = rtlOperation;
   }
   public FPArithmeticDecoder(String name, int addrMode1, int operandType1, int addrMode2, int operandType2, Operation rtlOperation) {
