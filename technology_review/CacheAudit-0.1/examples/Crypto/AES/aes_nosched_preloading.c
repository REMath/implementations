...
/*  Key schedule removed. Preloading of Tables (FSb,FT1,FT2,FT3) added.
*/
...
int main(){
  ...
  // normal aes computation

  aes_context mycontext;
  unsigned char mykey[16];
  unsigned char myinput[16];
  unsigned char myoutput[16];
  ...
  unsigned char* input=myinput;
  unsigned char* output=myoutput;
  ...
  /* Encryption only. Mode-flag is ignored */
