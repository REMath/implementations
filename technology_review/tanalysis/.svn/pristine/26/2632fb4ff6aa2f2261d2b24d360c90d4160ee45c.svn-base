/*
Description: An ad-hoc string copy with bounds check does not overflows a stack buffer.
Keywords: Port C Size0 Complex0 BufferOverflow Stack AdHocCopy Unbounded
ValidArg: "a"*30
VvalidArg: "a"*100
