...
public interface Instruction {
	 ...
	 * In sparc it is always 4 (= 32bits).
	 */
	public int getSize();

	/**
	 * Returns the operand with the given index, where 0 corresponds to the first operand.
	 * If the specified operand does not exist, returns null.
